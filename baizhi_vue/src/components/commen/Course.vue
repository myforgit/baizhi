        ...
        <div class="main">
            ...
            <div class="condition">
                <ul class="cate-list">
                    ...
                    <li v-for="cont in list_count" @click="category=cont.id" :class="category==cont.id?'this':''">
                        {{cont.name}}
                    </li>
                </ul>
            ...
            <div class="course-list">
                <div class="course-item" v-for="course in list_cot">
                    ...
                    <div class="course-info">
                        ...
                        <div class="pay-box" v-if="course.nuw_name">
                            <span class="discount-type">{{course.nuw_name}}</span>
                            <span class="discount-price">￥{{course.nuw_price}}元</span>
    ...
    export default {
        ...
        methods: {
            ...
            sum_course() {
                ...
                // 发送命令
                this.$axios({
                    url: this.$settings.HOST + "list/course/",
                    method: "get",
                    params: filters,
                }).then(red => {
                    console.log(red.data.results);
                    console.log(red.data);
                    this.list_cot = red.data.results;
                    this.total = red.data.count;
                }).catch(eroor => {
            ...
            sum() {
                this.$axios({
                    url: this.$settings.HOST + "list/sum/",
                    method: "get",
                }).then(red => {
                    this.list_count = red.data;
                    console.log(red.data)
                }).catch(eroor => {
                    console.log(eroor.request)
                })
