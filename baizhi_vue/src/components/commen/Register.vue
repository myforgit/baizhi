    ...
    <div class="box">
        ...
        <div class="register">
            <div class="register_box">
                ...
                <div class="inp">
                    <input v-model="mobile" type="text" placeholder="手机号码" class="user" @blur="verify">
                    ...
                    <button class="register_btn" @click="enroll">注册</button>
                    <p class="go_login">已有账号
                        <span><router-link to="/home/login">直接登录</router-link></span>
                    </p>
                </div>
            </div>
        </div>
...
<script>
    export default {
        ...
        methods: {
            verify(){
                this.$axios({
                    url:this.$settings.HOST+"login/verify/",
                    method: "post",
                    data:{
                        phone:this.mobile
                    }
                    ...
                    console.log(eroor);
                    this.$message.error(eroor.response.data);
                })
            },
            enroll() {
                this.$axios({
                    url: this.$settings.HOST + "login/enroll/",
                    method: "post",
                    data: {
                        phone: this.mobile,
                    ...
                    sessionStorage.user_id = red.data.id;
