...
from login.models import UserCourse
from order.models import Order
from product.views import log


class PaymentModel(APIView):
    ...
    def get(self, request):
        ...
        # 支付宝的公钥
        alipay_public_key_string = open(os.path.join(BASE_DIR, "apps/payment/keys/app_public_key.pem")).read()
...
class AliPaymentAPIView(APIView):
    """
